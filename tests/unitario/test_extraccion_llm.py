...
def test_extrae_campos_esperados(mock_llamar_llm, oferta_ejemplo, respuesta_llm_ejemplo):
...
@patch("src.extract.llamar_llm")
def test_maneja_respuesta_json_malformada_sin_lanzar_excepcion(mock_llamar_llm, oferta_ejemplo):
